...
console.log(
  `You will be accompanying ${cattleToDrive / 10} drovers as they drive ${cattleToDrive} cattle to Old Red's Ranch for grazing`,
);
console.log(
...
let breedsString = ``;
for (const cows of cattle) {
  breedsString += `${cows.breed}, `;
}
